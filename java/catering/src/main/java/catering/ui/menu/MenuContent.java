...
public class MenuContent {
    ...
    public void initialize() {
        ...
        sectionList.getSelectionModel().selectedItemProperty().addListener((observableValue, oldSection, newSection) -> {
        ...
        itemsList.getSelectionModel().selectedItemProperty().addListener((observableValue, oldItem, newItem) -> {
    ...
    public void modificaItemPressed() {
        ...
        if (result.isPresent() && !result.get().equals(mi.getDescription())) {
            try {
